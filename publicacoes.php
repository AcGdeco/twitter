    ...
    <div class="div-feed">
      <div class="container-publicacoes">
        <div class="bloco-publicacao">
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form"><textarea placeholder="Texto da Publicação" maxlength="5000" id="field" name="field" class="texto-publicar w-input"></textarea><input onclick = "publicar('primario')" value="Publicar" data-wait="Please wait..." class="botao-publicar w-button"></form>
        ...
        <div id = "publicacoes" >
        <?php include("BDPublicacoesSelect.php"); ?>
        </div>
