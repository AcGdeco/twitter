<?php
require_once("sessionVariaveis.php");
?>
<!DOCTYPE html>
...
<head>
  ...
  <script src="js/publicacoes.js" type="text/javascript"></script>
...
<body>
  <div class="topo-publicacoes w-clearfix">
    <div class="div-perfil">
      <p class="nome-perfil"><?php echo $nome; ?></p>
      
      <?php require_once("lateralFeeds.php"); ?>
    ...
    <div class="div-feed">
      <div class="container-publicacoes">
        <div class="bloco-publicacao">
          <div class="w-form">
            <form id="email-form" name="email-form" data-name="Email Form"><textarea placeholder="Texto da Publicação" maxlength="5000" id="field" name="field" class="texto-publicar w-input"></textarea><input onclick = "publicar()" value="Publicar" data-wait="Please wait..." class="botao-publicar w-button"></form>
        ...
        <div id = "publicacoes" >
        <?php include("BDPublicacoesSelectSecundario.php"); ?>
        </div>
